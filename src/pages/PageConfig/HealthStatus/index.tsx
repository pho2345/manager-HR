...
const TableList: React.FC = () => {
    ...
    const collection = `${SERVER_URL_CONFIG}/tinh-trang-suc-khoe`
    ...
    const columns: ProColumns<GEN.HealthStatus>[] = [
        {
            title: 'STT',
            dataIndex: 'index',
        ...
        {
            title: <FormattedMessage id="page.HealthStatus.table.name" defaultMessage="Name" />,
            key: 'name',
            dataIndex: 'name',
            render: (_, entity) => {
                ;
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.HealthStatus.modal.titleCreate" defaultMessage="Create Nation" />}
            ...
            <ModalForm
                title={<FormattedMessage id="page.HealthStatus.modal.titleUpdate" defaultMessage="Update Nation" />}
                form={form}
                width={window.innerWidth * 0.3}
