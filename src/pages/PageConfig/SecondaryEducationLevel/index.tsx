...
const TableList: React.FC = () => {
    ...
    const collection = `${SERVER_URL_CONFIG}/trinh-do-giao-duc-pho-thong`
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.SecondaryEducationLevel.modal.titleCreate" defaultMessage="Create Nation" />}
                ...
                <Row gutter={24} >
                    <Col span={24} >
                        <ProFormText
                            ...
                            // width='md'
                            name='name'
                            placeholder={`Tên trình độ giáo dục phổ thông`}
                            rules={[
                                {
                                    required: true,
            ...
            <ModalForm
                title={<FormattedMessage id="page.SecondaryEducationLevel.modal.titleUpdate" defaultMessage="Update Nation" />}
                form={form}
                width={window.innerWidth * 0.3}
