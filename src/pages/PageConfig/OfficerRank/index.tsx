...
const TableList: React.FC = () => {
    ...
    const collection = `${SERVER_URL_CONFIG}/bac-ngach/bac-ngach-vien-chuc`
    ...
    const columns: ProColumns<GEN.OfficerRank>[] = [
        {
            title: 'STT',
            dataIndex: 'index',
        ...
        {
            title: <FormattedMessage id="page.OfficerRank.table.name" defaultMessage="Name" />,
            key: 'name',
            dataIndex: 'name',
            render: (_, entity) => {
                ;
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.OfficerRank.modal.titleCreate" defaultMessage="Create Nation" />}
            ...
            >
                <Row gutter={24} >
                    <Col span={24} >
                        <ProFormText
                            label={<FormattedMessage id="page.OfficerRank.table.name" defaultMessage="Name" />}
                            // width='md'
                            name='name'
                            placeholder={`Tên bậc viên`}
                            rules={[
                                {
                                    required: true,
                                    message: <FormattedMessage id="page.OfficerRank.require.name" defaultMessage="Name" />
                                },
                            ]} />
                    </Col>
                </Row>
            ...
            <ModalForm
                title={<FormattedMessage id="page.OfficerRank.modal.titleUpdate" defaultMessage="Update Nation" />}
                form={form}
                width={window.innerWidth * 0.3}
