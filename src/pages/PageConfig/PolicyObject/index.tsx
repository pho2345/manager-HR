...
const TableList: React.FC = () => {
    ...
    const collection = `${SERVER_URL_CONFIG}/doi-tuong-chinh-sach`
    ...
    const columns: ProColumns<GEN.PolicyObject>[] = [
        {
            title: 'STT',
            dataIndex: 'index',
        ...
        {
            title: <FormattedMessage id="page.PolicyObject.table.name" defaultMessage="Name" />,
            key: 'name',
            dataIndex: 'name',
            render: (_, entity) => {
                ;
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.PolicyObject.modal.titleCreate" defaultMessage="Create Nation" />}
            ...
            >
                <Row gutter={24} >
                    <Col span={24} >
                        <ProFormText
                            label={<FormattedMessage id="page.PolicyObject.table.name" defaultMessage="Name" />}
                            // width='md'
                            name='name'
                            placeholder={`Tên đối tượng chính sách`}
                            rules={[
                                {
                                    required: true,
                                    message: <FormattedMessage id="page.PolicyObject.require.name" defaultMessage="Name" />
                                },
                            ]} />
                    </Col>
                </Row>
