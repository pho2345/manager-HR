...
const TableList: React.FC = () => {
    const collection = '/nhan-vien/ky-luat';
            ...
            >
                ...
                >
                    ...
                    <Row gutter={24} >
                        ...
                        <Col span={8} >
                            <ProFormText name="hinhThuc" key="hinhThuc" label="Hình thức kỷ luật" />
                        </Col>
                        <Col span={8} >
                            <ProFormText name="hanhViViPhamChinh" key="hanhViViPhamChinh" label="Hành vi vi phạm" />
                        </Col>
                    </Row>
