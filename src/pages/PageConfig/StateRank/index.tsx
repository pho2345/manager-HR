...
const TableList: React.FC = () => {
    ...
    const collection = `${SERVER_URL_CONFIG}/danh-hieu-nha-nuoc-phong`
    ...
    const columns: ProColumns<GEN.StateRank>[] = [
        {
            title: 'STT',
            dataIndex: 'index',
        ...
        {
            title: <FormattedMessage id="page.StateRank.table.name" defaultMessage="Name" />,
            key: 'name',
            dataIndex: 'name',
            render: (_, entity) => {
                ;
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.StateRank.modal.titleCreate" defaultMessage="Create Nation" />}
                    ...
                    <Col span={24} >
                        <ProFormText
                            ...
                            rules={[
                                {
                                    required: true,
                                    message: <FormattedMessage id="page.StateRank.require.name" defaultMessage="Name" />
                                },
                            ]} />
                    </Col>
                </Row>
            ...
            <ModalForm
                title={<FormattedMessage id="page.StateRank.modal.titleUpdate" defaultMessage="Update Nation" />}
                form={form}
                width={window.innerWidth * 0.3}
