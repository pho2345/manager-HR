...
const TableList: React.FC = () => {
    ...
    const collection = `${SERVER_URL_CONFIG}/trinh-do-chuyen-mon`
    ...
    const columns: ProColumns<GEN.ProfessionalLevel>[] = [
        {
            title: 'STT',
            dataIndex: 'index',
        ...
        {
            title: <FormattedMessage id="page.ProfessionalLevel.table.name" defaultMessage="Name" />,
            key: 'name',
            dataIndex: 'name',
            render: (_, entity) => {
                ;
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.ProfessionalLevel.modal.titleCreate" defaultMessage="Create Nation" />}
            ...
            >
                <Row gutter={24} >
                    <Col span={24} >
                        <ProFormText
                            label={<FormattedMessage id="page.ProfessionalLevel.table.name" defaultMessage="Name" />}
                            // width='md'
                            name='name'
                            ...
                            rules={[
                                {
                                    required: true,
                                    message: <FormattedMessage id="page.ProfessionalLevel.require.name" defaultMessage="Name" />
                                },
                            ]} />
                    </Col>
                </Row>
            ...
            <ModalForm
                title={<FormattedMessage id="page.ProfessionalLevel.modal.titleUpdate" defaultMessage="Update Nation" />}
                form={form}
                width={window.innerWidth * 0.3}
                ...
                <Row gutter={24} >
                    <Col span={24} >
                        <ProFormText
                            label={<FormattedMessage id="page.ProfessionalLevel.table.name" defaultMessage="Name" />}
                            name='name'
                            placeholder={`Tên trình dộ chuyên môn`}
                            rules={[
                                {
                                    required: true,
                                    message: <FormattedMessage id="page.ProfessionalLevel.require.name" defaultMessage="Name" />
