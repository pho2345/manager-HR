...
const TableList: React.FC = () => {
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.Sex.modal.titleCreate" defaultMessage="Create Sex" />}
            ...
            <ModalForm
                title={<FormattedMessage id="page.Sex.modal.titleUpdate" defaultMessage="Update Sex" />}
                form={form}
                width={window.innerWidth * 0.3}
