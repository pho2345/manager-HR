...
const TableList: React.FC = () => {
    ...
    const collection = `${SERVER_URL_CONFIG}/hoc-ham`
    ...
    const columns: ProColumns<GEN.AcademicDegrees>[] = [
        {
            title: 'STT',
            dataIndex: 'index',
        ...
        {
            title: <FormattedMessage id="page.AcademicDegrees.table.name" defaultMessage="Name" />,
            key: 'name',
            dataIndex: 'name',
            render: (_, entity) => {
                ;
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.AcademicDegrees.modal.titleCreate" defaultMessage="Create Nation" />}
            ...
            >
                <Row gutter={24} >
                    <Col span={24} >
                        <ProFormText
                            label={<FormattedMessage id="page.AcademicDegrees.table.name" defaultMessage="Name" />}
                            // width='md'
                            name='name'
                            placeholder={`Tên học hàm`}
                            rules={[
                                {
                                    required: true,
                                    message: <FormattedMessage id="page.AcademicDegrees.require.name" defaultMessage="Name" />
                                },
                            ]} />
                    </Col>
                </Row>
            ...
            <ModalForm
                title={<FormattedMessage id="page.AcademicDegrees.modal.titleUpdate" defaultMessage="Update Nation" />}
                form={form}
                width={window.innerWidth * 0.3}
