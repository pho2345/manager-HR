...
const TableList: React.FC = () => {
    const collection = `${SERVER_URL_CONFIG}/cap-nhom-chuc-danh-dang`;
    ...
    const columns: ProColumns<GEN.GroupRankCommunistParty>[] = [
        {
            title: 'STT',
            dataIndex: 'index',
        ...
        {
            title: 'Tên cấp nhóm chức danh đảng',
            key: 'name',
            dataIndex: 'name',
            render: (_, entity) => {
                ;
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={"Tạo mới cấp nhóm chức danh đảng"}
            ...
            >
                <Row gutter={24} >
                    <Col span={24} >
                        <ProFormText
                            label={"Tên cấp nhóm chức danh đảng"}
                            // width='md'
                            name='name'
                            placeholder={`Tên cấp nhóm chức danh đảng`}
                            rules={[
                                {
                                    required: true,
                                    message: "Tên cấp nhóm chức danh đảng"
                                },
                            ]} />
                    </Col>
                </Row>
            ...
            <ModalForm
                title={"Cập nhật cấp nhóm chức danh đảng"}
                form={form}
                width={window.innerWidth * 0.3}
