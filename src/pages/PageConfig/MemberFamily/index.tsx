...
const TableList: React.FC = () => {
    ...
    const collection = `${SERVER_URL_CONFIG}/thanh-phan-gia-dinh`
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.MemberFamily.modal.titleCreate" defaultMessage="Create Nation" />}
            ...
            <ModalForm
                title={<FormattedMessage id="page.MemberFamily.modal.titleUpdate" defaultMessage="Update Nation" />}
                form={form}
                width={window.innerWidth * 0.3}
