    ...
    return (
        <PageContainer>
            <ProTable
                ...
                request={async () =>  get('/trinh-do-chuyen-mon')}
                pagination={{
                    locale: {
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.ProfessionalLevel.modal.titleCreate" defaultMessage="Create ProfessionalLevel" />}
            ...
            <ModalForm
                title={<FormattedMessage id="page.ProfessionalLevel.modal.titleUpdate" defaultMessage="Update ProfessionalLevel" />}
                form={form}
                width={window.innerWidth * 0.3}
