...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<any>[] = [
    ...
    },
    {
      ...
      valueType: 'textarea',
      key: 'timeStart',
      renderText: (_, text: any) => moment(text?.attributes?.timeStart).format('YYYY-MM-DD HH:mm:ss')
    },
    {
      ...
      valueType: 'textarea',
      key: 'timeEnd',
      renderText: (_, text: any) => moment(text?.attributes?.timeEnd).format('YYYY-MM-DD HH:mm:ss')
    },
    {
      ...
      valueType: 'textarea',
      key: 'status',
      renderText: (_, text: any) => text?.attributes?.status
    },
    {
      ...
      renderText: (_, text: any) => text?.attributes?.quantitySellCpass
    },
    {
      ...
      renderText: (_, text: any) => text?.attributes?.quantityRemainCpass
    },
    {
  ...
  return (
    <PageContainer>
      <ProTable
        ...
        request={() => customAPIGet({'populate[0]': 'ward', 'populate[1]': 'district', 'populate[2]': 'province'}, 'fairs')}
        columns={columns}
        rowSelection={{
