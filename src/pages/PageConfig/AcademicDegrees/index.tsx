    ...
    return (
        <PageContainer>
            <ProTable
                ...
                request={async () => {
                    const data: GEN.AcademicDegrees[] = [
                        {
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.AcademicDegrees.modal.titleCreate" defaultMessage="Create AcademicDegrees" />}
            ...
            <ModalForm
                title={<FormattedMessage id="page.AcademicDegrees.modal.titleUpdate" defaultMessage="Update AcademicDegrees" />}
                form={form}
                width={window.innerWidth * 0.3}
