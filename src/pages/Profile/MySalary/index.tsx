...
const TableList: React.FC = () => {
    const collection = `${SERVER_URL_PROFILE_DETAIL}/ca-nhan/luong-ban-than`;
    ...
    const columns: ProColumns<GEN.MySalary>[] = [
        {
            title: 'STT',
            dataIndex: 'index',
        ...
        },
        {
            ...
            ...getColumnSearchProps('heSoLuong')
        },
        {
            title: "Bậc lương",
            key: 'bacLuong',
            ...
            ...getColumnSearchProps('bacLuong')
        },
        {
            title: "Tiền lương theo vị trí",
            key: 'tienLuongTheoViTri',
            dataIndex: 'tienLuongTheoViTri',
            render: (_, entity) => {
                ;
                return (
                    <> {entity?.tienLuongTheoViTri}</>
                );
            },
            ...getColumnSearchProps('tienLuongTheoViTri')
        },
        {
        ...
        <PageContainer>
            ...
            >
                <Row gutter={24} >
                    ...
                    <Col span={24} >
                        <ProFormDigit
                            label={"Tiền lương theo vị trí"}
                            // width='md'
                            name='tienLuongTheoViTri'
                            placeholder={`Tiền lương theo vị trí`}
                            rules={[
                                {
                                    required: true,
                                    message: 'Tiền lương theo vị trí'
                                },
                            ]}
