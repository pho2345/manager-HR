...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<any>[] = [
    ...
    },
    {
      ...
      render: (_, text: any) => {
        switch (text?.reasonSettlement) {
          case 'megaCanceled':
            return (<Text style={{ color: '#00CC00' }}>Mega chấp dứt trước hạn</Text>);
          case 'finished':
            return (<Text>Hết hạn<br />hợp tác</Text>);
          case 'inefficientFeed':
            return (<Text style={{ color: '#FF9900' }}>Nuôi không <br /> hiệu quả</Text>);
          case 'deathOrSick':
            return (<Text style={{ color: '#FF3333' }}>Bệnh chết</Text>);
            break;
          default:
            break;
        }
