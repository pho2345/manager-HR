    ...
    return (
        <PageContainer>
            <ProTable
                ...
                request={async () => get('/danh-hieu-nha-nuoc-phong-tang') }
                pagination={{
                    locale: {
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.StateRank.modal.titleCreate" defaultMessage="Create StateRank" />}
            ...
            <ModalForm
                title={<FormattedMessage id="page.StateRank.modal.titleUpdate" defaultMessage="Update StateRank" />}
                form={form}
                width={window.innerWidth * 0.3}
