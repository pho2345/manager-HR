...
const TableList: React.FC = () => {
    ...
    const collection = `${SERVER_URL_CONFIG}/bac-luong`
    ...
    return (
        <PageContainer>
            ...
            <ModalForm
                form={form}
                title={<FormattedMessage id="page.RankSalary.modal.titleCreate" defaultMessage="Create Nation" />}
            ...
            <ModalForm
                title={<FormattedMessage id="page.RankSalary.modal.titleUpdate" defaultMessage="Update Nation" />}
                form={form}
                width={window.innerWidth * 0.3}
