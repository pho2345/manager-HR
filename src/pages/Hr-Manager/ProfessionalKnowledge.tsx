...
const TableList: React.FC = () => {
    const collection = '/nhan-vien/nghiep-vu-chuyen-nganh';
    ...
    const columns: ProColumns<GEN.AdminProfessionalKnowledge>[] = [
        {
            title: 'STT',
            dataIndex: 'index',
        ...
        <PageContainer>
            ...
            <ModalForm
                ...
                onFinish={async (value) => {
                    if (value.nghiepVuChuyenNganh && value.nghiepVuChuyenNganh.length !== 0) {
                        const newData = value.nghiepVuChuyenNganh.map((e: any) => {
            ...
            >
                ...
                <ProFormList
                    name="nghiepVuChuyenNganh"
                    creatorButtonProps={{
                        creatorButtonText: 'Thêm một nghiệp vụ chuyên ngành',
                    }}
                    min={1}
                    copyIconProps={false}
                    itemRender={({ listDom, action }, { index }) => (
                        <ProCard
                            ...
                            title={`Nghiệp vụ chuyên ngành ${index + 1}`}
                            extra={action}
                ...
                >
                    ...
                    <Row gutter={24} >
                        ...
                        <Col span={12} >
                            <ProFormSelect name="tenCoSoDaoTao" key="tenCoSoDaoTao" label="Cơ sở đào tạo" request={() => getOption('/coquan-tochuc-donvi', 'id', 'name')} />
                        </Col>
