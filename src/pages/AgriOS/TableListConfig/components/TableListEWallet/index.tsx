...
const handleAdd = async (fields: API.RuleListItem) => {
    ...
    console.log(fields);
    try {
        await customAPIAdd({ ...fields }, 'config-plaforms/add/e-wallet');
        hide();
...
const TableList: React.FC = () => {
    ...
    const columns: ProColumns<any>[] = [
        ...
        {
            title: configDefaultText['page.eWallet.name'],
            dataIndex: 'nameBank',
            valueType: 'textarea',
            key: 'nameBank',
    ...
    return (
        <>
            <ProTable
                ...
                request={() => customAPIGet({}, 'e-wallets/get/plaform')}
                columns={columns}
                rowSelection={{
                    ...
                    <Col span={24} className="gutter-row p-0">
                        <ProFormText
                            rules={[
                                {
                                    required: true,
                                    message: configDefaultText['page.eWallet.name'],
                                },
                            ]}
                            width='md'
                            label={configDefaultText['page.eWallet.name']}
                            name='name'
                            placeholder={configDefaultText['page.eWallet.name']}
                        />
                    </Col>
                </Row>
